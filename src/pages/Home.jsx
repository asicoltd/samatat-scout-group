...
const Home = () => {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      subtitle: 'Developing character, leadership, and community spirit through scouting excellence since 1999.'
    },
    {
      id: 4,
      ...
      <section className="gallery-preview section">
        <div className="container">
          ...
          <div className="gallery-preview__cta">
            <Link to="/gallery" className="btn btn-primary">Explore Full Gallery</Link>
      ...
      <section className="programs section pattern-bg">
        <div className="container">
          ...
          <div className="programs__cta">
            <Link to="/programs" className="btn btn-primary">Explore All Programs</Link>
          </div>
        </div>
      </section>
